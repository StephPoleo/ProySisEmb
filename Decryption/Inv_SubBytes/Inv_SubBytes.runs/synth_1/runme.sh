...
HD_PWD='C:/Users/isaac/Desktop/6to Semestre/Sistemas embebidos/AES-EM18/Decryption/Inv_SubBytes/Inv_SubBytes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inv_SubBytes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inv_SubBytes.tcl
