...
HD_PWD='C:/ProySisEmb/Proy_Vivado/SubBytes_Decrypt/SubBytes_Decrypt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SubBytes_Decrypt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SubBytes_Decrypt.tcl
